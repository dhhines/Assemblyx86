...
;------------------------------------------------
         ...
         cmp       dl,term_ch                   ; Compare to the term_ch (period)
         je        output                       ; ... if equal to term_ch goto output label
         cmp       dl,spc_ch                    ; Compare to space
         je        output                       ; ... if equal to spc_ch goto output label


         mov       dl,al                        ; ..... to complete this task
                                                ; ..... if all checks pass then keep moving
                                                ;
                                                ;
;------------------------------------------------
