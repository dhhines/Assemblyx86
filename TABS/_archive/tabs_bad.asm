...
asc_cr   db        0Dh                          ; ASCII carriage return character
...
getclp:                                         ; label for code to capture clp if exists
         ...
         mov        [num_sp], al                ; store the decimal value in [num_sp] variable
;------------------------------------------------
...
setspcs:                                        ; Label for set spaces routine
         mov       cl, [num_sp]                 ; move number of spaces for tab into cl
         mov       ch, 0                        ; ... and ensure ch register is zero since count is data byte
...
;------------------------------------------------
; clears the counter when line feed input then falls thru to output
;------------------------------------------------
