...
exptab:                                         ; Label for expand tab to spaces routine
         ...
         mov       cl,[num_sp]                  ; Move the tab stop position (tsp) into cl
         sub       cl,ah                        ; subtract remainder in ah from tsp for index into spaces string
         mov       dx, [spcstr + cl]            ; move the ASCII value for space character into dl register
